...
const CatalogListScreen = ({ navigation }: FlatListScreenProps) => {
  ...
  //This returns a flatlist whit all my products
  return (
    <View>
      <FlatList
        data={userData}
...
//This Screen display the pressed product you have chossen
const ProductScreen = ({ route }: ProductsScreenProps) => {
  return (
    <View style={styles.containerProductInfo}>
      <Image
        style={styles.imageViewProductInfo}
      ...
      <Text
        style={{
          ...
          ...(DiscountColor(route.params.price)
            ? styles.textTrue
            : styles.textFalse),
        }}
        //This display the Discount price in red color
      >
        {DiscountPrice(route.params.price).toFixed(2)} $
      </Text>
      <Text style={styles.headlineProductInfo}>Description</Text>
      <Text style={styles.descriptionProductInfo}>
        {route.params.description}
      </Text>
      <Text style={styles.categoryProductInfo}>
...
//Color for discount product if the price is over 50 $
...
//Functionallity for my Product card
